...
class _PendingTempleDetailScreenState extends State<PendingTempleDetailScreen> {
  ...
  String _getProjectId() {
    ...
    print("🔴 ADMIN SIDE - Project Document ID: '$id'");
    print("🔴 ADMIN SIDE - Available fields: ${widget.temple.keys.toList()}");
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Temple data: ${widget.temple.toString()}',
                style: GoogleFonts.poppins(
  ...
  Widget _buildSiteImagesCard(BuildContext context) {
    ...
    final rawData = widget.temple['imageUrls'] ??
        widget.temple['images'] ??
        widget.temple['siteImages'];
  ...
  Widget _buildContactBudgetCard() {
    final double amount =
        double.tryParse((widget.temple['estimatedAmount'] ?? '0').toString()) ??
            0.0;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  _isEditingAmount ? Icons.close : Icons.edit,
                  size: 18,
                  color: maroonDeep,
                ),
                onPressed: () {
                  setState(() {
                    ...
                    if (!_isEditingAmount) {
                      _amountController.text =
                          widget.temple['estimatedAmount']?.toString() ?? '0';
                    }
                  });
                },
              ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(color: maroonLight),
                    ),
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                      borderSide: BorderSide(color: maroonDeep, width: 2),
                    ),
                  ),
                ),
                const SizedBox(height: 12),
  ...
  void _updateEstimatedAmount() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          .collection('projects')
          .doc(docId)
          .update({'estimatedAmount': newAmount});
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Estimated amount updated successfully'),
