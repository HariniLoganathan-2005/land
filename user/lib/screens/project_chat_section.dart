          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                return Center(child: Text("Error loading feedback", style: GoogleFonts.poppins()));
              }
                  ...
                  return Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isSystem ? Colors.blue[50] : (isMe ? myBubbleColor : Colors.white),
                        borderRadius: BorderRadius.circular(12),
                        border: isSystem ? Border.all(color: Colors.blue[200]!) : null,
                        boxShadow: [
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                          ...
                          color: isSystem ? Colors.blue[800] : (isMe ? Colors.white : Colors.black87),
                        ),
                      ),
                    ),
                  );
